function day_2025_10_21_coding()
    ...
    tr_error_list2 = zeros(1, n_samples);
     ...
     for n = 1:length(h_ref_list)
         ...
         [XB1,XB2,~] = explicit_RK_step_embedded(my_rate, tspan(1), V0, h_ref, DormandPrince);
    ...
    loglog(num_evals, k1*h_ref_list.^p1, 'k', 'linewidth', 1);
    loglog(num_evals, k2*h_ref_list.^p2, 'k', 'linewidth', 1);
