function day_2025_10_21_coding()
    ...
    loglog(h_ref_list, k1*h_ref_list.^p1, 'b', 'linewidth', 1);
    loglog(h_ref_list, k2*h_ref_list.^p2, 'g', 'linewidth', 1);

    xlabel("Step Size h");
    ylabel("Error");
    title('Truncation vs Step Size');
    legend("Difference","First Embeded Method", "Second Embeded Method")
hold off
